...
import TestScenarios.Signin;

public class ExtentTestNGListener extends Signin implements ITestListener
{
		 ...
		 */
		ExtentReports extent=ExtentTestNGManager.getInstance();
